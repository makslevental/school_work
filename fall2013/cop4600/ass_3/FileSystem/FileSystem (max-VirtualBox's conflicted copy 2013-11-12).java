...
class FileSystem {
      ...
      public static void warning()
      {
        ...
        System.out.println("**************************************");
        System.out.println("**************************************");
        System.out.println("All commands respect full paths       ");
        System.out.println("E.g.");
        System.out.println("mkdir a");
        System.out.println("cd a");
        System.out.println("a/>mkdir b");
        System.out.println("a/>cd ..");
        System.out.println("cd a/b/");
        System.out.println("a/b/>");
        System.out.println("a/b/>cd root");
        System.out.println("touch a/b/newFile");
        System.out.println("vi a/b/newFile 123");
        System.out.println("cd a/b/");
        System.out.println("a/b/>more newFile");
      ...
      public static void newCommands()
      {
        System.out.println("*************************************************************************");
        System.out.println("                            New Commands                                 ");
        System.out.println("*************************************************************************");
        System.out.println("vi filename string         adds string to filename on a new line");
        System.out.println("root                       returns you to root directory");
        System.out.println("cd ..                      works the same as up command");
        System.out.println("cp filename1 filename2     Copy now can copy virtual files that have been \"touched\" and vi-ed");
        System.out.println("                           E.g. ");
        System.out.println("                           touch newFile");
        System.out.println("                           vi newFile 123");
        System.out.println("                           cp newFile newerFile");
        System.out.println("                           more newerFile");
        System.out.println("                           123");
        System.out.println("**************************************");
        System.out.println("**************************************");
    }
    ...
    public static void help()
      {       
        ...
        System.out.println("stat -s filename           Resolves symbolic link and shows number of blocks and number of links for file filename");
    ...
    public static void createFile(String[] parameters){
       ...
       if (i != -1)
       {
          ...
          if (j != -1){
            ...
            System.out.println("Cannot create file: no available data block");
          }
       }
       else {
    ...
    public static void copy(String file1, String file2){
       ...
       if (m  != -1){
          ...
          if (k != -1) {
              ...
              // if file2 is a link copy actually copies over the linked to file
              if(temp.getLink()){
          ...
          if (i != -1){
            ...
            // some bug. forget which. i think there's a bug if cp from an empty file
            if(blockAddressesFile1 == null){
              int j = Block.newDataBlock();
              int r = Block.newDataBlock();
              if (j != -1){
                inodefile1.addBlock(j);
                inodefile2.addBlock(r);
                inodefile2.linkCount++;
              }
              else System.out.println("Cannot create file: source file is empty and no extra room");
            }
            else{
    ...
    public static void showInfo(String file){
      ...
      if (i != -1)
      {
         ...
         else if(currentWorkingDirectoryDirNode.isHardLink(filename))
            System.out.print("HardLink ");
    ...
    public static void hardLink(String file1, String file2){
        ...
        currentWorkingDirectoryDirNode.addEntry(filename,i, true);
        Inode inode = (Inode)Block.getBlock(i);
        inode.linkCount++;
      ...
      if (file.equals("root")) {
        ...
        if (i == -1){
         ...
         if(inode.getLink()){
           ...
           changWorkDir(dirPrep(dataBuffer.toString()));
         }
