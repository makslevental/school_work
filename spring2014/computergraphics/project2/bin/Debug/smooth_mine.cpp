...
display(void)
{
    ...
    std::cout << "num triangles " << model->numtriangles << std::endl;
    std::cout << "name " << model->pathname << std::endl;
    for(int i =0; i < model->numtriangles; i++){

        std::cout << "triangle " << i+1 << std::endl;
        int vindex1 = model->triangles[i].vindices[0];
        int vindex2 = model->triangles[i].vindices[1];
        int vindex3 = model->triangles[i].vindices[2];

        std::cout << vindex1 << std::endl;
        std::cout << vindex2 << std::endl;
        std::cout << vindex3 << std::endl;

        double vertex1 = model->vertices[vindex1];
        double vertex2 = model->vertices[vindex2];
        double vertex3 = model->vertices[vindex3];
        printf("%f \n", model->vertices[vindex1]);
        printf("%f \n", model->vertices[vindex2]);
        printf("%f \n", model->vertices[vindex3]);
        std::cout << (float)model->vertices[vindex1] << std::endl;
        std::cout << (float)model->vertices[vindex2] << std::endl;
        std::cout << (float)model->vertices[vindex3] << std::endl;
