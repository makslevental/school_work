...
%     noisySignal = step(hAWGN,ifftSignal);
    noisySignal25db = ifftSignal + (1/10^(25/10))*exp(1i *2*pi*(rand(2^6,1)));
    noisySignal15db = ifftSignal + (1/10^(15/10))*exp(1i *2*pi*(rand(2^6,1)));
    noisySignal5db = ifftSignal + (1/10^(5/10))*exp(1i *2*pi*(rand(2^6,1)));
